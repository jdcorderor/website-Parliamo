        ...
        <section id="comunidad" className="w-[80vw] py-16 mx-auto mt-40 md:mt-120">
            ...
            <div ref={ref} className="grid grid-cols-1 md:grid-cols-3 gap-6 py-6 md:py-12">
                <div className="flex flex-col justify-center gap-1 text-center">
                    ...
                    <p className="md:text-lg font-montserrat text-gray-500 font-light">Estudiantes actuales</p>
                </div>

                <div className="flex flex-col justify-center gap-1 text-center">
                    <h3 className="text-3xl md:text-5xl font-cardo text-[#3064B7] font-semibold">
                        <Counter target={600} suffix="+" visible={visible} />
                    </h3>
                ...
                <div className="flex flex-col justify-center gap-1 text-center">
                    <h3 className="text-3xl md:text-5xl font-cardo text-[#3064B7] font-semibold">
                        <Counter target={1200} suffix="+" visible={visible} />
                    </h3>
