            ...
            <div className="relative w-full h-250 pt-45 md:pt-64">
                ...
                <div ref={sectionRef} className="relative z-10 mx-auto">
                    <div className="flex flex-col md:w-[80vw] mx-auto gap-2">
                        ...
                        <p className="md:text-lg font-montserrat text-[#032386] font-semibold text-center md:text-left">Descubre la belleza de hablar italiano.</p>
                    </div>
                    ...
                    <div className={`flex flex-col md:flex-row py-16 gap-16 ${ sectionVisible ? 'slide-from-left' : 'opacity-0' }`}>
                        <div className="w-[95vw] md:w-[60vw]">
                            <img src="/main/image2.avif" alt="No solo visites Italia, vívela." className="w-full md:h-100 object-cover rounded-r-2xl" />
                        </div>

                        <div className="flex flex-col w-[80vw] md:w-[40vw] gap-6 mx-auto md:mx-0">
                            <h2 className="text-xl md:text-3xl font-montserrat text-[#032386] font-bold md:w-[40%] text-center md:text-left">No solo visites Italia, <i>vívela</i>.</h2>
                            <p className="md:text-lg font-montserrat md:w-[65%] text-center md:text-left">Aprender el idioma es una forma hermosa de conectar con tus raíces, entender la historia de tu familia y mantener viva la herencia cultural para las siguientes generaciones.</p>
